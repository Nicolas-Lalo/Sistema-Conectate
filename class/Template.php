  ...
  */
  public function getHead()
  {
    $head = '<!DOCTYPE html>
                <html>
                <head>
                <link  rel="icon"   href="dist/img/tekanto.png" type="image/png" />
                  <meta charset="utf-8">
                  <meta http-equiv="X-UA-Compatible" content="IE=edge">
                  <title>H. Ayuntamiento 2018-2021 </title>
  ...
  public function menuLateral()
  {
    ...
    $menuLateral = '  <aside class="main-sidebar sidebar-dark-primary elevation-4">
                        ...
                        <a href="'.$this->ruta.'inicio.php" class="brand-link">
                          <img src="'.$this->ruta.'dist/img/escudo.png"
                               alt="AdminLTE Logo"
                               class="brand-image elevation"
                               style="opacity: 1">
                          <span class="brand-text font-weight-light"> H.Ayuntamiento</span>
                        </a>
                        <!-- Sidebar -->
                        <div class="sidebar">
                          ...
                          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                            <div class="image">
                              <img src="'.$this->ruta.'dist/img/escudo.png" class="img-circle elevation-2" alt="User Image">
                            </div>
                            <div class="info">
    ...
    $bodyButton = '</div>
                    <footer class="main-footer">
                        <div class="float-right d-none d-sm-block">
                          <small> H. Ayuntamiento de Tekantó 2028-2021</small>
                        </div>
                    </footer>
                    <!-- Control Sidebar -->
