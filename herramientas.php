      ...
      <div class="card card-info">
          ...
          <div class="card-body">
             <div class="input-group mb-3">
                <label for="emisor" class="col-form-label">De:</label>
                </p> <input type="text" class="form-control" placeholder="De:" aria-label="Username" aria-describedby="addon-wrapping">
              </div>

          <div class="input-group mb-3">
            <label for="receptor" class="col-form-label">Para:</label>
            <input type="text" class="form-control" placeholder="Para:" aria-label="Recipient's username" aria-describedby="basic-addon2">
          </div>
          ...
          <div class="input-group mb-3">
           ...
           <button class="btn btn-info" type="button" id="inputGroupFileAddon03">Enviar</button>
